    ...
    @foreach($workers as $worker)
        <tr>
            ...
            <td>
                ...
                <div class='btn-group'>
                    <a href="{!! route('workers.show', [$worker->id]) !!}" class='btn btn-default btn-xs'><i class="glyphicon glyphicon-eye-open"></i></a>
                    <a href="{!! route('workers.edit', [$worker->id]) !!}" class='btn btn-default btn-xs'><i class="glyphicon glyphicon-edit"></i></a>
